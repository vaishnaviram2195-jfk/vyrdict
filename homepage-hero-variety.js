(()=>{
  ...
  const STYLE_ID='vyrdict-hero-baccarat-size';
  ...
  function addStyle(){
    ...
    s.id=STYLE_ID;
    s.textContent=`
      body.vyrdict-home-calm .stage .p1 img{transform:scale(1.85)!important;transform-origin:center center!important}
      @media(max-width:700px){body.vyrdict-home-calm .stage .p1 img{transform:scale(1.75)!important}}
    `;
