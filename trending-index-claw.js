(()=>{
  if(window.__vyrdictTrendingClawV6)return;
  window.__vyrdictTrendingClawV6=1;
  ...
  function addStyle(){
    if(document.getElementById('vyrdict-trending-claw-v6-style'))return;
    const s=document.createElement('style');
    s.id='vyrdict-trending-claw-v6-style';
    s.textContent=`
      .vyrdict-index-claw{--ink:#171511;--cream:#f4ede5;--paper:#fffaf5;--machine:#d9b7ae;--machine2:#c99996;--machine3:#eedbd3;--teal:#9fc8c6;--rose:#d98a9d;position:relative;overflow:hidden;background:linear-gradient(180deg,#f7f0eb,#efe3dc)!important;padding:60px 0 68px!important;border:0!important}
      ...
      .vyrdict-index-claw .vti-grid{display:grid;grid-template-columns:minmax(320px,.78fr) minmax(0,1.22fr);gap:28px;align-items:stretch}
      ...
      .vyrdict-index-claw .vti-machine-stage{display:grid;place-items:center;background:linear-gradient(145deg,rgba(255,250,245,.72),rgba(229,211,201,.62));position:relative}

      .vyrdict-index-claw .vti-machine{position:relative;width:290px;height:490px;filter:drop-shadow(0 18px 18px rgba(69,47,39,.17));transform:translateY(2px)}
      ...
      .vyrdict-index-claw .vti-reveal-card{position:relative;background:linear-gradient(145deg,#fffaf6,#f8ede7 57%,#ebd9d2);border:1px solid rgba(255,255,255,.72)}
      ...
      .vyrdict-index-claw .vti-reveal-link{position:absolute;inset:60px 25px 122px;display:flex;align-items:center;justify-content:center;opacity:0;transform:scale(.88);transition:opacity .32s ease,transform .52s cubic-bezier(.18,.85,.2,1);z-index:2}.vyrdict-index-claw .vti-reveal-link.is-on{opacity:1;transform:scale(1)}.vyrdict-index-claw .vti-reveal-link img{width:88%;height:88%;object-fit:contain;filter:drop-shadow(0 25px 28px rgba(67,43,33,.18))}
      ...
      @media(max-width:760px){.vyrdict-index-claw{padding:50px 0 58px!important}.vyrdict-index-claw .vti-wrap{width:min(100% - 24px,680px)}.vyrdict-index-claw .vti-head{grid-template-columns:1fr;gap:8px}.vyrdict-index-claw .vti-sub{text-align:left}.vyrdict-index-claw .vti-grid{grid-template-columns:1fr;gap:14px}.vyrdict-index-claw .vti-machine-stage{height:525px}.vyrdict-index-claw .vti-reveal-card{height:500px}.vyrdict-index-claw .vti-foot{flex-direction:column}.vyrdict-index-claw .vti-hint{text-align:left}}
    `;
