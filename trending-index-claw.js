(()=>{
  ...
  function addStyle(){
    ...
    s.textContent=`
      ...
      .vyrdict-index-claw .vti-reveal-card{position:relative;background:linear-gradient(145deg,rgba(255,250,245,.72),rgba(229,211,201,.62));border:1px solid rgba(255,255,255,.72)}
