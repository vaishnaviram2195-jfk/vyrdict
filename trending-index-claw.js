(()=>{
  if(window.__vyrdictTrendingClawV7)return;
  window.__vyrdictTrendingClawV7=1;
  ...
  function addStyle(){
    if(document.getElementById('vyrdict-trending-claw-v7-style'))return;
    const s=document.createElement('style');
    s.id='vyrdict-trending-claw-v7-style';
    s.textContent=`
