...
module.exports=async function handler(req,res){
  try{
    ...
    const schema={
      ...
      brand:{'@type':'Brand',name:brand},image:[image],description:p.product_description||p.viral_summary||verdict,
      category:p.category||'',url:canonical,
      review:{'@type':'Review',name:`${fullName} review`,url:canonical,datePublished:reviewed,dateModified:reviewed,reviewBody,
